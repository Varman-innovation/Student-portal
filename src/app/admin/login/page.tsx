  ...
  return (
    <main className="admin-login">
      <div className="glass-card">
        ...
        <h2>Welcome back</h2>
        <p className="subcopy">Use the local MVP credentials. Override them with environment variables before deployment.</p>
        <div className="demo-note">Default local login: <strong>admin / admin123</strong></div>
        <form onSubmit={submit}>
          <div className="field"><label htmlFor="username">Admin ID</label><div className="input-wrap"><input id="username" className="input" value={username} onChange={(e) => setUsername(e.target.value)} autoComplete="username" /></div></div>
